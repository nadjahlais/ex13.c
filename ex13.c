...
int main (void)
{
		int mudar,flag=0,i,novaescolha=0,ganhoumudando=0,ganhousemmudar=0,perdeusemmudar=0,perdeumudando=0,porta1=0,porta2=0,porta3=0,escolho1,escolho2,escolho3,gerapremio,geraescolha;
			srand(time(NULL));
				...
				//																																																																																																															}
				//																																																																																																																
				//																																																																																																																		//bloco responsavel por gerar a segunda escolha garatid pelo ultimo if que que a primeira érrada,a variavel mudar vai fazer a esolha do jogador, se mudar=0, ele ficou com a primeira opç,se nao ele mudou, a flag éara que apenas cada escolha seja avaliada a cada loop.
